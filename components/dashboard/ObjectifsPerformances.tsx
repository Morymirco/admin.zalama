              ...
              <div className="mt-3 space-y-3">
                <div className="w-[320px]">
                  ...
                  <div className="h-2.5 bg-[var(--zalama-bg-darker)] rounded-full overflow-hidden w-full">
                    <div className="h-full bg-[var(--zalama-blue)] rounded-full" style={{ width: '75%' }}></div>
                  </div>
                </div>
                <div className="w-[320px]">
                  <div className="flex justify-between text-xs mb-1">
                  ...
                  <div className="h-2.5 bg-[var(--zalama-bg-darker)] rounded-full overflow-hidden w-full">
                    <div className="h-full bg-[var(--zalama-blue)] rounded-full" style={{ width: '82%' }}></div>
                  </div>
                </div>
                <div className="w-[320px]">
                  <div className="flex justify-between text-xs mb-1">
                  ...
                  <div className="h-2.5 bg-[var(--zalama-bg-darker)] rounded-full overflow-hidden w-full">
                    <div className="h-full bg-[var(--zalama-blue)] rounded-full" style={{ width: '60%' }}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-3 space-y-3">
                <div className="w-[320px]">
                  ...
                  <div className="h-2.5 bg-[var(--zalama-bg-darker)] rounded-full overflow-hidden w-full">
                    <div className="h-full bg-[var(--zalama-blue)] rounded-full" style={{ width: '90%' }}></div>
                  </div>
                </div>
                <div className="w-[320px]">
                  <div className="flex justify-between text-xs mb-1">
                  ...
                  <div className="h-2.5 bg-[var(--zalama-bg-darker)] rounded-full overflow-hidden w-full">
                    <div className="h-full bg-[var(--zalama-green)] rounded-full" style={{ width: '85%' }}></div>
                  </div>
                </div>
                <div className="w-[320px]">
                  <div className="flex justify-between text-xs mb-1">
                  ...
                  <div className="h-2.5 bg-[var(--zalama-bg-darker)] rounded-full overflow-hidden w-full">
                    <div className="h-full bg-[var(--zalama-green)] rounded-full" style={{ width: '78%' }}></div>
                  </div>
                </div>
              </div>
            </div>
